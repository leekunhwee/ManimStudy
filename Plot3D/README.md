...
<p align="center"><img src ="CameraPosition1.gif" /></p>
...
class CameraPosition2(ThreeDScene):
    def construct(self):
        ...
        self.wait()
```
<p align="center"><img src ="CameraPosition2.gif" /></p>
...
class CameraPosition3(ThreeDScene):
    def construct(self):
        ...
        self.wait()
```
<p align="center"><img src ="CameraPosition3.gif" /></p>

<p align="center"><img src ="Angles.png" /></p>
...
class CameraPosition4(ThreeDScene):
    def construct(self):
        ...
        self.wait()
```
<p align="center"><img src ="CameraPosition4.gif" /></p>
...
class CameraPosition5(ThreeDScene):
    def construct(self):
        ...
        self.wait()
```
<p align="center"><img src ="CameraPosition5.gif" /></p>
...
class MoveCamera1(ThreeDScene):
    def construct(self):
        ...
        self.wait()
```
<p align="center"><img src ="MoveCamera1.gif" /></p>
...
class MoveCamera2(ThreeDScene):
    def construct(self):
        ...
        self.move_camera(phi=80*DEGREES,theta=-PI/2)  #Return the position
        self.wait()
```
<p align="center"><img src ="MoveCamera2.gif" /></p>
...
class ParametricCurve(ThreeDScene):
    def construct(self):
        ...
        self.wait()
```
<p align="center"><img src ="ParametricCurve.gif" /></p>
...
```
<p align="center"><img src ="surface.gif" /></p>